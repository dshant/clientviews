...
export function Reply({ replyId }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const url = `/api/v1/reply/${replyId}`;
  ...
  return (
    <div className="card">
      <h1 className="card-header">Add your Reply</h1>
      <div className="card-body">
        <p>You can respond to the following message:</p>
        <div className="mb-5" style={{ borderLeft: "gray solid 5px" }}>
